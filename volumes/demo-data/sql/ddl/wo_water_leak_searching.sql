...
CREATE TABLE qwc_geodb.wo_water_leak_searching (
    ...
    status_state text COLLATE pg_catalog."default",
    inspected_length text COLLATE pg_catalog."default",
    prelocation_techniques text COLLATE pg_catalog."default",
...
CREATE UNIQUE INDEX IF NOT EXISTS wo_water_leak_searching_id_pkey ON qwc_geodb.wo_water_leak_searching USING btree (id);
CREATE UNIQUE INDEX IF NOT EXISTS wo_water_leak_searching_task_id_key ON qwc_geodb.wo_water_leak_searching USING btree (task_id);
CREATE UNIQUE INDEX IF NOT EXISTS wo_water_leak_searching_datadesk_id_key ON qwc_geodb.wo_water_leak_searching USING btree (datadesk_id);
CREATE INDEX IF NOT EXISTS wo_water_leak_searching_geom_idx ON qwc_geodb.wo_water_leak_searching USING gist (geom);
CREATE INDEX IF NOT EXISTS wo_water_leak_searching_contract_code_idx ON qwc_geodb.wo_water_leak_searching USING btree (contract_code);
CREATE INDEX IF NOT EXISTS wo_water_leak_searching_tsvector_idx ON qwc_geodb.wo_water_leak_searching USING gin (tsvector);
CREATE INDEX IF NOT EXISTS wo_water_leak_searching_moveo_id ON qwc_geodb.wo_water_leak_searching USING btree (moveo_id);
--CREATE INDEX IF NOT EXISTS wo_water_leak_searching_trgm_idx ON qwc_geodb.wo_water_leak_searching USING gin (trgm gin_trgm_ops);